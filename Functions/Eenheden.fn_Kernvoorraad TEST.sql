...
create function [Eenheden].[fn_Kernvoorraad TEST] (@Peildatum date = null) 
returns table 
as
/* ###################################################################################################
VAN         : JvdW
...
Versie 2: 20210113 Nav definitie Margot
...
SELECT  Opmerking = case when CTE_H.huurprijsklasse_corpo_descr <> 'Duur boven hoogste grens'
									...
									then 'Kernvoorraad - oude netto huur onder liberalisatiegrens'
														...
														else 'Geen kernvoorraad Den Haag' end end
		 ,Kernvoorraad = case when CTE_H.huurprijsklasse_corpo_descr <> 'Duur boven hoogste grens'
														and TT.[Analysis Group Code] like '%WON%'									
														and BRONOGE.Plaats = 'DEN HAAG'
									then 1 
									else case when CTE_H.huurprijsklasse_corpo_descr = 'Duur boven hoogste grens'
														and TT.[Analysis Group Code] = 'WON ZELF'						-- geldt niet voor onzelfstandige woningen
														and BRONOGE.Plaats = 'DEN HAAG'
														...
														and  year(CTE_A.Ingangsdatum) <= 2016							-- tot en met 2016 kon er sprake zijn van inkomensafhankelijke hvh
														then 1
														else 0 end end
