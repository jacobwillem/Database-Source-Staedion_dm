...
CREATE procedure [dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk VERVALLEN](
...
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200131'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200229'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200331'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200430'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200531'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200630'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200731'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200831'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20200930'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20201031'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20201130'
exec staedion_dm.[dbo].[sp_load_kpi_projecten_renovaties_gestart_tijdelijk] '20201231'
select * from empire_staedion_Data.etl.LogboekMeldingenProcedures

declare @fk_indicator_id as smallint
select @fk_indicator_id = min(id) from  [Dashboard].[Indicator] where lower([Omschrijving]) like '%start%renovati%'
...
BEGIN TRY
  ...
  -- Diverse variabelen
		...
		select @fk_indicator_id = min(id) from  [Dashboard].[Indicator] where lower([Omschrijving]) like '%start%renovaties%'
