...
CREATE VIEW [Datakwaliteit].[CheckGeliberaliseerdeContracten]
AS
/*
...
JvdW 20210112 Aanpassing - foutje geconstateerd bij OGEH-0005220
...
SELECT Eenheidnr = BRON.Nr_
	   ...
	   ,[Controle-bevinding] = CASE WHEN CONTR.Ingangsdatum < '19940701' THEN 'Geen controle nodig - gezien ingangsdatum sociaal contract'	-- select top 10 *
