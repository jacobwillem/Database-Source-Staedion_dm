CREATE TABLE [Dashboard].[RealisatieDetails_20211207_MV]
(
...
GO
ALTER TABLE [Dashboard].[RealisatieDetails_20211207_MV] ADD CONSTRAINT [PK_RealisatieDetails2] PRIMARY KEY CLUSTERED ([id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_RealisatieDetails_Datum2] ON [Dashboard].[RealisatieDetails_20211207_MV] ([Datum]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_RealisatieDetails_fk_indicator_id2] ON [Dashboard].[RealisatieDetails_20211207_MV] ([fk_indicator_id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_RealisatieDetails_fk_indicator_id_Datum2] ON [Dashboard].[RealisatieDetails_20211207_MV] ([fk_indicator_id], [Datum]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_RealisatieDetails_Laaddatum2] ON [Dashboard].[RealisatieDetails_20211207_MV] ([Laaddatum]) ON [PRIMARY]
GO
