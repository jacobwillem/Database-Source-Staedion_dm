...
GO
ALTER TABLE [Projecten].[Projecttype_werksoort] ADD CONSTRAINT [FK_Projecttype_werksoort_Bedrijf] FOREIGN KEY ([bedrijf_id]) REFERENCES [Algemeen].[Bedrijven] ([Bedrijf_id])
GO
